...
function redirTwitter() {
	window.open("http://www.twitter.com/SegHorizonte");
}
...
/* Manejo de fotos */
function laFoto(nombre){
	jQuery.get("http://localhost:9000/tomar",{"nombre":nombre},function(resultado){
		alert("Se ha agregado la foto en /sdcard/imagenes/" + resultado)
	})
}
